...
'''
reference_dir = '/mnt/nvme/work/phone_labeling/ref'  # here we have the annotated data
dataset_dir = '/mnt/nvme/work/phone_labeling/img_raw'  # here are the images
checkpoints_dir = '/mnt/nvme/adas/code/phone_labeling/networks/'
...
class NetworkTool(object):
    ...
    def save_checkpoint(self, model, epoch, loss, optimizer):
        ...
        torch.save(model,self.path_checkpoint + '_net'+str(epoch) + '.pt')
